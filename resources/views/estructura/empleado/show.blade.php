    ...
    <div class="row clearfix">
        <div class="col-md-12">
            <div class="alert alert-warning">
                <p class="h4"><strong>Datos del empleado, </strong> gestiona la información de cada una de los empleados
                    de la empresa.
                </p>
            </div>
        </div>
                        ...
                        <table class="table table-hover">
                            ...
                            <tr class="read">
                                <td class="contact bg-green" colspan="2">
                                    <center><b>Información del empleado</b></center>
                                </td>
                            </tr>
                            <tr class="read">
                            ...
                            <tr class="read">
                                <td class="contact bg-green" colspan="2">
                                    <center><b>Contacto de Emergencia</b></center>
                                </td>
                            </tr>
                            <tr class="read">
                                <td class="contact"><b>Nombre</b></td>
                            ...
                            <tr class="read">
                                <td class="contact bg-green" colspan="2">
                                    <center><b>Lavadoras Asignadas</b></center>
                                </td>
                            </tr>
                            @foreach($persona->lavadoras as $lavadora)
                                <tr class="read">
                                    <td colspan="2"
                                        class="contact">{{$lavadora->serial.' - '.$lavadora->marca.' -BODEGA:'.$lavadora->bodega->nombre}}</td>
                                </tr>
                            @endforeach
                            </tbody>
                        </table>
