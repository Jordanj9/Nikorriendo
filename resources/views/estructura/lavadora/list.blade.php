...
@section('breadcrumb')
    ...
    <ol class="breadcrumb">
        ...
        <li class="active"><a><i class="fa fa-camera-retro"></i> Lavadoras</a></li>
    </ol>
@endsection
@section('content')
    <div class="row clearfix">
        <div class="col-md-12">
            <div class="alert alert-warning">
                <p class="h4"><strong>Detalles: </strong> gestiona la información de cada una de las lavadoras de la
                    empresa.
                </p>
            </div>
        </div>
                    ...
                    @foreach($lavadoras as $lavadora)
                        <tr>
                            ...
                            @if($lavadora->estado_bodega == 'SI')
                                <td style="color: #0e6f5c">
                                    <center>{{$lavadora->estado_bodega}}</center>
                                </td>
                            @else
                                <td style="color: #9e0505">
                                    <center>{{$lavadora->estado_bodega}}</center>
                                </td>
                            @endif
                            @if($lavadora->estado_lavadora == 'DISPONIBLE')
                                <td style="color: #0e6f5c">
                                    <center>{{$lavadora->estado_lavadora}}</center>
                                </td>
