            ...
            <div class="row clearfix">
                <div class="col-md-12" style="margin-bottom: 30px">
                    <div class="form-group">
                        <br/>{!! Form::select('persona_id',$personas,null,['class'=>'form-control','placeholder'=>'Seleccione el Empleado','onchange="traerData()"','id'=>'grupousuario_id']) !!}
                    </div>
                </div>
                <div class="col-md-5">
                    <div class="card">
                        <div class="body bg-red" style="padding: 10px">
                            <strong>LAVADORAS DEL SISTEMA</strong>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="form-line">
                            {!! Form::select('lavadoras[]',$lavadoras,null,['class'=>'form-control','style'=>'height: 400px','placeholder'=>'-- Seleccione una opción --','multiple','size="20"','id'=>'paginas']) !!}
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-5">
                    ...
                    <div class="form-group">
                        <div class="form-line">
                            <select name="lavadoras[]" id="privilegios" class="form-control" style="height: 400px" multiple="" size="20" required="required"></select>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-md-12">
