    ...
    <body class="hold-transition skin-red sidebar-mini">
        ...
        <div class="wrapper">
            ...
            <aside class="main-sidebar">
                ...
                <section class="sidebar">
                    ...
                    <div class="user-panel">
                        <div class="pull-left image" style="margin-top: 40px">
                            <img src="{{ asset('dist/img/user-160x160.jpg')}}" class="img-circle" alt="User Image">
                        </div>
                    ...
                    <ul class="sidebar-menu" data-widget="tree">
                        ...
                        <li class="active"><a href="{{route('admin.mantenimiento')}}"><i class="fa fa-wrench"></i>
                        ...
                        @if($location=='reporte')
                        <li class="active"><a href="{{route('admin.reporte')}}"><i class="fa fa-line-chart"></i>
                                <span>Reportes</span></a>
                        </li>
                        @else
                        <li><a href="{{route('admin.reporte')}}"><i class="fa fa-line-chart"></i>
            ...
            <footer class="main-footer">
                ...
                <strong> &copy;2019 <a href="#">Jordan Cuadro, Camilo Colon y Alberto Rojas.</a></strong>
            </footer>
        </div>
        <!-- ./wrapper -->
