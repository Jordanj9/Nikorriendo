    ...
    <body>
        <nav class="navbar navbar-inverse">
            <div class="container-fluid">
                <div class="navbar-header">
                    <a class="navbar-brand" href="#">Entregar Cambio</a>
                </div>
            </div>
        </nav>
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                ...
                <ol class="breadcrumb">
                    ...
                    <li><a href="{{route('solicitud.index')}}"><i class="fa fa-indent"></i> Solicitudes de Cambio</a></li>
                    <li class="active"><a><i class="fa fa-users"></i> Entregar </a></li>
                </ol>
            </section>
            <!-- Main content -->
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group">
                        <label>Seleccione las lavadoras que pretende cambiar</label>
                        <select class="form-control show-tick select2" name="lavadoras_ser[]" id="lavadoras_ser" required="" multiple="">
                            @foreach($lavadoras_ser as $key=>$value)
                ...
                <div class="col-md-12">
                    ...
                    <div class="opciones">
                        <form method='post' action='#' ENCTYPE='multipart/form-data'>
                            <button id="btn-limpiar" class="btn btn-info pull-right" value="Limpiar"><i class="fa fa-sticky-note-o"></i></button>
                        </form>
                    </div>
                </div>
            </div>
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        <div class="col-md-12" style="margin-top: 20px !important">
                            ...
                            <a class="btn btn-danger icon-btn pull-right" href="{{route('solicitud.index')}}"><i class="fa fa-fw fa-lg fa-times-circle"></i>Cancelar</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <script>
                                ...
                                function guardar(event) {
                                    ...
                                    const lavadoras_ser = $('#lavadoras_ser').val();
                                    if (lavadoras.length == 0 || lavadoras_ser.length == 0) {
                                    ...
                                    if (lineas.length == 0) {
                                        writeMessage('Error: firma requeridaa');
                                        return;
                                    }
                                    axios.post('{{url('/servicio/solicitud/guardarCambio')}}', {
                                        base_64: imagen,
                                        lavadoras: lavadoras,
                                        lavadoras_ser: lavadoras_ser,
