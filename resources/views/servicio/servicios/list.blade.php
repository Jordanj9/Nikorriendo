                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>@if($servicio->estado == 'PENDIENTE')
                            ...
                            @elseif($servicio->estado == 'ASIGNADO')
                            ...
                            @elseif($servicio->estado == 'CAMBIO')
                            <label class="label label-default">{{$servicio->estado}}</label>
                            @else
                        ...
                        <td style="text-align: center;">
                            ...
                            @if((session('ROL') == 'CENTRAL' || session('ROL') == 'ADMINISTRADOR') && $servicio->estado == 'ENTREGADO')
                            <a data-toggle="tooltip" data-placement="top" title="Solicitud de Cambio" onclick="cambio(event,'{{$servicio->id}}')" style="color: deeppink; margin-left: 10px;"><i class="fa fa-exclamation-circle"></i></a>
                            @endif
                            ...
                            @endif
                            @if(session('ROL') == 'CENTRAL' || session('ROL') == 'ADMINISTRADOR' && $servicio->estado == 'ENTREGADO')
                            <a href="#" onclick="recoger(event,'{{$servicio->id}}')" data-toggle="tooltip" data-placement="top" title="Recoger Servicio" style="color: orange; margin-left: 10px;"><i class="fa  fa-repeat"></i></a>
                            @endif
                            <a href="#" onclick="observacion(event,'{{$servicio->id}}')" data-placement="top" title="Observación del Servicio" style="color: #00a157; margin-left: 10px;"><i class="fa fa-file-text"></i></a>
                        </td>
                    </tr>
                    @endforeach
                </tbody>
...
<script type="text/javascript">
                                ...
                                responsive: true,
                                        "order": [[ 7, "desc" ]], //or asc 
                                        "columnDefs" : [{"targets":7, "type":"date-es"}],
                                        "pageLength":25,
                                });
                                });
                                ...
                                title: 'Estas seguro(a)?',
                                        ...
                                        confirmButtonColor: '#3085d6',
                                        cancelButtonColor: '#d33',
                                        confirmButtonText: 'Si, Recoger!',
                                        cancelButtonText: 'cancelar'
                                }).then((result) => {
                                if (result.value) {
                                let url = 'cambiorecoger/' + id;
